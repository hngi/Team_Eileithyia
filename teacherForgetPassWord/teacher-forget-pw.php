<?php
   require_once("process-teacher-foget-pw.php");
?>
...
<body>
        ...
        <div class="container-fluid" style="margin-top: 150px;">
            <div class="row justify-content-around">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 bg bg-primary">
                    <h2 class="text-center text-light" style="margin-bottom: 2%">Teacher's Forget Password</h2>
                    
                  <?php
                  
                  if (isset($_GET['status']) && $_GET['status'] == 'recovered' ) {
                     echo "<div class='col-lg-7 col-md-7 col-sm-7 col-xs-7 alert alert-successful'>Successful, Mail sent to you email, click here to <a href='../application/views/teacher/signin.php' class='text-light'>login</a></div>";
                  }

                elseif (isset($teacherErrMessForgetPw)) {
                    
                echo "<div class='col-lg-7 col-md-7 col-sm-7 col-xs-7 alert alert-danger'>$teacherErrMessForgetPw</div>";
                }
                  ?>
                   ...
                   <form method="POST" action="<?php ?>">
                    ...
                    <div class="form-group">
                        <input type="text" name="teacher_recoverName" placeholder="Fullname" class="form-control">
                    </div>

                    <div class="form-group">
                        <input type="email" name="teacher_recoverEmail" placeholder="Email address" class="form-control">
                    </div>
                    
                    
                    <div class="form-group">
                        <button type="submit" name="teacher_recoverPwButton" class="btn btn-primary form-control"> Recover </button>
    ...
    <div class="container footer" style="margin-top: 250px;">
        <div class="row">
